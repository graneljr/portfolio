    ...
    >
      ...
      >
          ...
          <div className="flex flex-1 flex-col gap-3">
            <div className="w-full flex flex-col gap-0.5">
              <span className="w-full flex items-center justify-between">
                ...
                >Armando Granel Jr</h1>
                <button
                  onClick={() => setDark(!dark)}
                  className={`relative w-16 h-8 p-0.5 border transition-colors duration-400 ${
                    dark
                ...
                >
                  <div
                    className={`absolute top-1 left-1 w-6 h-6 bg-transparent flex ${dark ? "text-white" : "text-muted"} items-center justify-center shadow-sm transition-all duration-400`}
                    style={{
        ...
        <div className="flex gap-7 w-full">
          <div className="w-[60%] flex flex-col px-5 py-6 shadow-sm gap-3 border border-gray-200 dark:border-white/20  rounded-xl">
